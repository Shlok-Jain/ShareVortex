    ...
    <div id="navigator">
      <div className="container-nav">
        <Link to='/' onClick={() => showLoading()} className="navigate-elem">
          ...
          <div className="navigate-text">Home</div>
        </Link>
        <Link onClick={() => showLoading()} to='/editprofile' className="navigate-elem">
          <div className="navigate-icon">
          ...
          <div className="navigate-text">Edit Profile</div>
        </Link>
        <Link onClick={() => showLoading()} to='/posts' className="navigate-elem">
          <div className="navigate-icon">
          ...
          <div className="navigate-text">Posts</div>
        </Link>
        <Link onClick={() => showLoading()} to='/addpost' className="navigate-elem">
          <div className="navigate-icon">
          ...
          <div className="navigate-text">Add a Post</div>
        </Link>
        <div onClick={() => logout()} className="navigate-elem">
          <div className="navigate-icon">
          ...
          <div className="navigate-text">Logout</div>
        </div>
      </div>
    </div>
  )
